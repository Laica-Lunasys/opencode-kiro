...
`opencode-kiro` `0.5.0-beta.3` is built and tested against one pinned OpenCode v2
...
| `kiro-acp-ai-provider` | `3.0.0` | dependencies (exact) |
...
3. Confirm the installed pins match this table:
   ...
   ```bash
   cd "${XDG_CACHE_HOME:-$HOME/.cache}/opencode/packages/opencode-kiro@0.5.0-beta.3"
